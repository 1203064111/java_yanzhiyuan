...
public class OrderLogisticsBean implements Serializable{
	...
	private OrderAddressBean orderAddressBean;//发货地址
	List<OrderLogisticsDetailBean> orderLogisticsDetailBeans;//物流详情列表
	...
	public OrderLogisticsBean setOrder_merchants_no(String order_merchants_no) {
