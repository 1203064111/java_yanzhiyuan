...
public class FreightBean implements Serializable{
	...
	private String freight_way;//1:包邮 2:卖家承担运费
	...
	private List<FreightCityBean> freightCityBeans;//
	...
	public FreightBean setMerchants_name(String merchants_name) {
	...
	public FreightBean setSort_type(String sort_type) {
	...
	public FreightBean setFreight_type(String freight_type){
		...
		this.freight_type_show="1".equals(freight_type)?"按件":"2".equals(freight_type)?"按重量":"按体积";
		return this;
	}
