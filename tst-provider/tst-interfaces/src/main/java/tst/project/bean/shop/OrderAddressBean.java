...
public class OrderAddressBean implements Serializable{
	...
	private String changer_id;//兑换id
	...
	private String assress_detailed_road;//
	...
	public OrderAddressBean setChanger_id(String changer_id) {
	...
	public OrderAddressBean setAddress_road(String address_road){
		...
		this.assress_detailed_road = this.address_detailed+this.address_road;
		return this;
	}
	public String getAssress_detailed_road() {
		return assress_detailed_road;
	}
	public OrderAddressBean setAssress_detailed_road(String assress_detailed_road) {
		this.assress_detailed_road = assress_detailed_road;
		return this;
	}
