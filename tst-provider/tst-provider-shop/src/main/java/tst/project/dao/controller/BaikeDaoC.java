...
public interface BaikeDaoC {
	 ...
	 * @param pageBean
	 */
	public List<BaikeClassBean> getBaikeClasss(BaikeClassBean baikeClassBean, PageBean pageBean);
	 ...
	 * @return
	 */
	public int insertBaikeClass(BaikeClassBean baikeClassBean);
	 ...
	 * @return
	 */
	public int updateBaikeClass(BaikeClassBean baikeClassBean);
	 ...
	 * @return
	 */
	public int deleteBaikeClass(BaikeClassBean baikeClassBean);
