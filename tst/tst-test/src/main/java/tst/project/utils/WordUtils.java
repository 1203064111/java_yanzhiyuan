...
public class WordUtils {
	...
	public static void main(String[] args) {
		...
		String url = "jdbc:mysql://139.196.178.64:3306/tst_information?characterEncoding=utf-8";
		createWord("口呗资讯部分数据库文档",url,username,password);
		
	}
	
	public static boolean createWord(String title,String url,String username,String password) {
		try {
			Document document = new Document(PageSize.A4);
			System.out.println(new WordUtils().getPath() + title+".doc");
			...
			String sql = "select table_name,table_comment from information_schema.tables where table_schema = 'tst_information';";
